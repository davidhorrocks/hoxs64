...
public:
	...
	virtual HRESULT LoadReu1750(unsigned int extraAddressBits) = 0;
	virtual HRESULT LoadReu1750FromFile(const TCHAR* filename, bool autoSizeExtraAddressBits, unsigned int extraAddressBits) = 0;
