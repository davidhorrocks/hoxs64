...
public:
	...
	HRESULT Init(bit8 *charGen, bool isReu, bool isQuickload, bool isPrgAlwaysQuickload);
	...
	bool SelectedWantPrgAlwaysQuickload;
...
private:
	...
	HWND m_hCheckReu;
	HWND m_hCheckPrgAlwaysQuickLoad;
	int m_width_custom;
	int mgapTop;
	int mgapBottom;
	bool mbGapsDone;
