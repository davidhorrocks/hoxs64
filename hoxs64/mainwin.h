...
public:
	...
	void CalcEmuWindowSize(RECT rcMainWindow, int *w, int *h);
	...
	HRESULT SetCoopLevel(bool bWindowed, bool useCurrentWindowPlacement, bool bDoubleSizedWindow, bool bWindowedCustomSize, int xpos, int ypos, int width, int height, bool bUseBlitStretch);
	HRESULT InitSurfaces(bool bWindowed, bool useCurrentWindowPlacement, bool bDoubleSizedWindow, bool bWindowedCustomSize, int xpos, int ypos, int width, int height, bool bUseBlitStretch);
	void ClearSurfaces();
	HRESULT ToggleFullScreen();
	HRESULT SetWindowedMode(bool wantWindowed, bool useCurrentWindowPlacement, bool bDoubleSizedWindow, bool bWindowedCustomSize, int width, int height, bool bUseBlitStretch);
